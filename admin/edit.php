  ...
  <body>
    ...
    <div class="list">
      <?php foreach ( $posts_array as $post ) : ?>
  					...
  					<p class="name"><?php echo $post->post_title ?></a> || <a href="./edit.php?id=<?php echo $post->ID; ?>&edit=1" >EDIT</a> || <a href="./delete.php?id=<?php echo $post->ID; ?>"> DELETE </a></p>

            <?php if (!empty($_GET['edit']) && $_GET['edit'] == 1) { ?>
                <form method="post" enctype="multipart/form-data" action="edit.php?id=<?php echo $post->ID?>">
