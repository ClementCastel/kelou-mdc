...
<body style="background-color:rgb(29,29,29);">
    <div style="width:100%;height:100%;margin:0;padding:0;">
        ...
        <div class="row" id="do-a-research" style="margin-bottom:10px;min-height:60px;border:double 2px rgb(0,0,0);border-radius:5px;height:65px;">
            <div class="col-lg-12" style="padding:0;margin:0;background-color:#ccc;color:rgb(0,0,0);font-size:25px;font-weight:normal;border-top-left-radius:5px;border-bottom-left-radius:5px;"><a href="../search.php"><button class="btn btn-primary" type="button" style="width:100%;height:100%;margin:0;padding:0;color:rgb(255,255,255);font-size:35px;font-family:'Barlow Condensed', sans-serif;font-weight:bold;border-radius:0;border:0;">Faire une recherche ?</button></a></div>
        </div>
